...
public static class FloodFillByTerrain
{
    public static IEnumerable<IntVec3> Fill(IntVec3 s, IntVec3 t)
    {
        ...
        while (cells.Count() > 0 && ret.Count() < DesignatorShapes.Settings.FloodFillCellLimit)
        {
            ...
            else if (floorAtMouse != null)
            {
                if (cellFloor?.defName == floorAtMouse.defName)
                {
                    addFlag = true;
                    neighborsFlag = true;
                }
            ...
            else if (cellWall == null && cellMineable == null && cellFloor == null)
            {
                addFlag = true;
                neighborsFlag = true;
